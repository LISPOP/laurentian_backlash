...
data_francophone<-dataprep(foo=subset(pc, Year>2017), 
...
pc$District
pc %>% 
  subset(District %in% francophone)
pc %>% 
  filter(francophone==1) %>% 
  filter(Year>2017) %>% 
